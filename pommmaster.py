...
async def login_form(request: Request, error: str | None = None):
    ...
    return HTMLResponse(LOGIN_PAGE.replace("{err_html}", f'<div class="p-3 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-mono">{error}</div>' if error else ''))
